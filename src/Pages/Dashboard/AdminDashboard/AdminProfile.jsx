    ...
    <div className="max-w-3xl mx-auto mt-10 p-6 bg-white shadow-lg rounded-2xl">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative">
          ...
          <label
            className="absolute bottom-1 right-1 bg-gray-800 text-white p-2 rounded-full cursor-pointer hover:bg-black"
          >
            <Camera size={14} />
            <input
              type="file"
      ...
      <div className="mt-10">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-4 border rounded-xl bg-gray-50">
            <p className="text-gray-500 text-sm">Lessons Moderated</p>
            <h3 className="text-xl font-bold">12</h3>
          </div>
          <div className="p-4 border rounded-xl bg-gray-50">
            <p className="text-gray-500 text-sm">Actions Taken</p>
